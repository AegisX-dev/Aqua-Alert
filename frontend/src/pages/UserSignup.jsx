    ...
    return (
        ...
        <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                {/* Email Field */}
                <div>
                <label htmlFor="email" className="flex text-sm font-medium text-foreground mb-2 items-center">
                    Email Address
                </label>
                <input
                    type="email"
            ...
            <div className="mt-6 text-center">
                ...
                <button 
                    ...
                    className="text-aqua-blue hover:underline font-medium cursor-pointer"
                >
                    Sign in
                </button>
                </p>
